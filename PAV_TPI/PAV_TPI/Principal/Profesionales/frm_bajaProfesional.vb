Public Class frm_bajaProfesional
    ...
    Private Sub frm_bajaProfesional_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dtp_fechaNac.Value = form_Profesional.dgv_resultados.CurrentRow.Cells(4).Value
        ...
        'txt_fechaAlta.Text = form_Profesional.dgv_resultados.CurrentRow.Cells(9).Value
